...
public class Gw2ApiTest {
    ...
    public static void main(String[] args) {
       ...
       String responseBody;
        ...
        try {
            connectionManager = new HttpsConnectionManager(Gw2ApiTest.StartComRootCertificate);
        ...
        try {
            response = httpClient.execute(getEvents);
            responseBody = HttpsConnectionManager.stringFromHttpResponse(response);
...
//            JsonParser jsonParser = gsonFactory.createJsonParser(reponseBody);
//            jsonParser.parse(eventArray);
