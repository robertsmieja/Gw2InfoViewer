...
//    private static final String WORLD_ID = "?world_id=1001";
    ...
    private MainController() {
        ...
        try {
            ...
            this.eventList = JsonConversionService.parseEventListJson(httpClient.execute(getEvents).getEntity().getContent());
            httpClient.getConnectionManager().shutdown();

            httpClient = HttpsConnectionFactory.getHttpsClient(StartComRootCertificate);
            eventNames = HttpsConnectionFactory.getStringFromHttpResponse(httpClient.execute(getEventNames));
            this.eventNameMap = JsonConversionService.parseNameMapJson(eventNames);
            httpClient.getConnectionManager().shutdown();
