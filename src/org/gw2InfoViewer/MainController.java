...
public class MainController {
    ...
    private static final String WORLD_ID = "?world_id=1001";
//    private static final String WORLD_ID = "";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            events = HttpsConnectionFactory.stringFromHttpResponse(httpClient.execute(getEvents));
            eventNames = HttpsConnectionFactory.stringFromHttpResponse(httpClient.execute(getEventNames));
        ...
        eventList = jsonService.parseEventListJson(events);
        eventNameMap = jsonService.parseNameMapJson(eventNames);
        
        for (Event event: eventList.getEventList()){
            event.setEventName(eventNameMap.getNameMap().get(event.getEventId()));
        }
        
        mainView.setEventsListModel(eventList);
        mainView.setEventNameMap(eventNameMap);
    }
}
